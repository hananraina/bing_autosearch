const btn_start = document.getElementById("btn-start"),
  ...
  slc_interval = document.getElementById("slc-interval"),
  chk_multitab = document.getElementById("chk-multitab"),
  span_progress = document.getElementById("span-progress"),
  div_bing_iframe = document.getElementById("div-bing-iframe"),
  BING_AUTOSEARCH = {
    terms: {
      list: [
        ...
        "Assassin's Creed: Alta\xefr's Chronicles",
        ...
        "Pok\xe9mon Advanced Generation: Pico for Everyone Pok\xe9mon Loud Battle!",
        "Pok\xe9mon Art Academy",
        "Pok\xe9mon Bank",
        "Pok\xe9mon Battle Revolution",
        "Pok\xe9mon Battle Trozei",
        "Pok\xe9mon Battrio",
        "Pok\xe9mon Black/White",
        "Pok\xe9mon Black/White Version 2",
        "Pok\xe9mon Box",
        "Pok\xe9mon Breeder Mini",
        "Pok\xe9mon Caf\xe9 Mix",
        "Pok\xe9mon Card GB2: GR-dan Sanjou!",
        "Pok\xe9mon Card Game: How To Play DS",
        "Pok\xe9mon Channel",
        "Pok\xe9mon Chasm Crosser",
        "Pok\xe9mon Co-Master",
        "Pok\xe9mon Colosseum",
        "Pok\xe9mon Conquest",
        "Pok\xe9mon Crystal",
        "Pok\xe9mon Dash",
        "Pok\xe9mon Diamond/Pearl",
        "Pok\xe9mon Dream Radar",
        "Pok\xe9mon Duel",
        "Pok\xe9mon Emerald",
        "Pok\xe9mon FireRed/LeafGreen",
        "Pok\xe9mon Fushigi no Dungeon: Ikuzo! Arashi/Mezase! Hikari/Susume! Honoo no Boukendan",
        "Pok\xe9mon Ga-Ol\xe9",
        "Pok\xe9mon Go",
        "Pok\xe9mon Gold/Silver",
        "Pok\xe9mon HeartGold/SoulSilver",
        "Pok\xe9mon Masters",
        "Pok\xe9mon Mega Get!",
        "Pok\xe9mon Mystery Dungeon: Blue/Red Rescue Team",
        "Pok\xe9mon Mystery Dungeon: Explorers of Darkness/Time",
        "Pok\xe9mon Mystery Dungeon: Explorers of Sky",
        "Pok\xe9mon Mystery Dungeon: Gates to Infinity",
        "Pok\xe9mon Mystery Dungeon: Go For It! Light Adventure Squad",
        "Pok\xe9mon Mystery Dungeon: Magnagate and the Infinite Labyrinth",
        "Pok\xe9mon Mystery Dungeon: Rescue Team DX",
        "Pok\xe9mon Omega Ruby/Alpha Sapphire",
        "Pok\xe9mon Party Mini",
        "Pok\xe9mon Picross",
        "Pok\xe9mon Pinball",
        "Pok\xe9mon Pinball Mini",
        "Pok\xe9mon Pinball: Ruby & Sapphire",
        "Pok\xe9mon Platinum",
        "Pok\xe9mon Play It!",
        "Pok\xe9mon Play It! 2",
        "Pok\xe9mon Pok\xe9 Ball Launcher",
        "Pok\xe9mon Project Studio Red/Blue Version",
        "Pok\xe9mon Puzzle Challenge",
        "Pok\xe9mon Puzzle Collection",
        "Pok\xe9mon Puzzle Collection Vol.2",
        "Pok\xe9mon Puzzle League",
        "Pok\xe9mon Quest",
        "Pok\xe9mon Race Mini",
        "Pok\xe9mon Ranger",
        "Pok\xe9mon Ranger: Guardian Signs",
        "Pok\xe9mon Ranger: Shadows of Almia",
        "Pok\xe9mon Red/Blue",
        "Pok\xe9mon Ruby/Sapphire",
        "Pok\xe9mon Rumble",
        "Pok\xe9mon Rumble Blast",
        "Pok\xe9mon Rumble U",
        "Pok\xe9mon Rumble World",
        "Pok\xe9mon Seek & Find	",
        "Pok\xe9mon Shuffle",
        "Pok\xe9mon Sleep",
        "Pok\xe9mon Smile",
        "Pok\xe9mon Snap",
        "Pok\xe9mon Stadium",
        "Pok\xe9mon Stadium 2",
        "Pok\xe9mon Sun/Moon",
        "Pok\xe9mon Super Mystery Dungeon",
        "Pok\xe9mon Team Rocket Blast Off",
        "Pok\xe9mon Team Turbo",
        "Pok\xe9mon Tetris Mini",
        "Pok\xe9mon Trading Card Game",
        "Pok\xe9mon Trading Card Game Online",
        "Pok\xe9mon Tretta",
        "Pok\xe9mon Trozei!",
        "Pok\xe9mon Typing Adventure",
        "Pok\xe9mon Ultra Sun/Ultra Moon",
        "Pok\xe9mon Unite",
        "Pok\xe9mon X/Y",
        "Pok\xe9mon XD: Gale of Darkness",
        "Pok\xe9mon Yellow: Special Pikachu Edition",
        "Pok\xe9mon Zany Cards",
        "Pok\xe9mon for Nintendo Switch (Working Title)",
        "Pok\xe9mon ie TAP?",
        "Pok\xe9mon: Masters Arena",
      ...
      random: () =>
        BING_AUTOSEARCH.terms.list[
          Math.floor(Math.random() * BING_AUTOSEARCH.terms.list.length)
        ],
    },
    cookies: {
      set(e, o, a) {
        try {
          ...
          let n = `${e}=${o};expires=${r.toUTCString()};path=/`;
          document.cookie = n;
        } catch (i) {}
      },
      get(e) {
        ...
        try {
          document.cookie.split(";").forEach((a) => {
            0 == (a + "=").trim().indexOf(e) &&
              (o = a.substring(e.length + 2, a.length));
          });
        } catch (a) {}
      ...
      load() {
        ...
        if (
          ...
          r.value
            ? (slc_interval.value = BING_AUTOSEARCH.search.interval =
                parseInt(r.value.toString()))
            : (e.show(),
              BING_AUTOSEARCH.cookies.set("_search_interval", "5000", 365)),
          a.value)
        )
          chk_multitab.checked = "true" === a.value;
        else {
          var n;
          (n = navigator.userAgent || navigator.vendor || window.opera),
            (/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino|android|ipad|playbook|silk/i.test(
              ...
              (chk_multitab.checked = !0),
            BING_AUTOSEARCH.cookies.set(
              "_multitab_mode",
              chk_multitab.checked,
              365
            );
        }
      },
      ...
      iframe: {
        add(e, o) {
          ...
          a.setAttribute("src", e),
            ...
            div_bing_iframe.firstChild &&
              div_bing_iframe.removeChild(div_bing_iframe.firstChild),
            div_bing_iframe.appendChild(a);
        },
      },
      start() {
        for (let e = 1; e <= BING_AUTOSEARCH.search.limit; e++) {
          let o =
              BING_AUTOSEARCH.terms.random().toLowerCase() +
              (chk_multitab.checked ? ` (${e})` : ""),
            a = `https://www.bing.com/search?q=${encodeURI(
              o
            )}&offset=0&count=1`;
          setTimeout(() => {
            (span_progress.innerText = `(${e}/${BING_AUTOSEARCH.search.limit})`),
              e === BING_AUTOSEARCH.search.limit &&
                setTimeout(() => {
                  BING_AUTOSEARCH.search.stop();
                }, BING_AUTOSEARCH.search.interval),
              chk_multitab.checked
                ? BING_AUTOSEARCH.search.window.open(a)
                : BING_AUTOSEARCH.search.iframe.add(a, o);
          }, (e - 1) * (BING_AUTOSEARCH.search.interval - 500));
        }
      },
      stop() {
...
window.addEventListener("load", () => {
  ...
  BING_AUTOSEARCH.cookies.load(),
    ...
    chk_multitab.addEventListener("change", () => {
      BING_AUTOSEARCH.cookies.set("_multitab_mode", chk_multitab.checked, 365);
    }),
    slc_interval.addEventListener("change", () => {
      BING_AUTOSEARCH.cookies.set("_search_interval", slc_interval.value, 365),
        location.reload();
    }),
    (window.dataLayer = window.dataLayer || []),
    e("js", new Date()),
    e("config", "G-YXNCPPFVCW");
});
